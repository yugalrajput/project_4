<%@page import="in.co.rays.model.proj4.RoleModel"%>
<%@page import="in.co.rays.controller.proj4.UserListCtl"%>
	...
	<form action="<%=ORSView.USER_LIST_CTL%>" method="post">
		...
		<center>
			...
			<table width="80%" align="center">
                ...
                <label>LastName</font> :
					</label> <input type="text" name="lastName" placeholder="Enter First Name"
			...
			<table border="1" width="100%" align="center" cellpadding=6px
				...
				<tr style="background: #E5E4E2">
					...
					<th width="8%"><input type="checkbox" id="select_all" name="Select">Select All.</th>
